        ...
        <NavLink to={"/chathistory/" + props.id}>
                <li className={style.girl_item}>
                    ...
                    <div className={style.text_box}>
                        ...
                        <span className={style.item_girl_from}> {props.age} years, from {props.city}</span>
                    </div>
                </li>
            </NavLink>
    )
    ...
    return (
        <div className="chat_item">
            ...
            <div className={style.message}>
                <div className={style.message_ava}>
    ...
    return (
        <div className="chat_item">
            ...
            <div className={style.my_message}>
                <div className={style.my_message_ava}>
...
const ChatIndex = (props) => {
    ...
    let chatsElements = 
    props.chatsPage.chatsData.map( chat => <ChatItem key={chat.id} name={chat.name} id={chat.id} age={chat.age} city={chat.city} />);
    let messageElements = 
    props.chatsPage.messagesData.map( msg => <Message key={msg.id} message={msg.message} id={msg.id} />);
    let myMessageElements =
    props.chatsPage.myMessagesData.map(mymssg => <MyMessage key={mymssg.id} myMessage={mymssg.myMessage} id={mymssg.id} />);
...
<div className={style.dialogs}>
    <div className={style.l_sidebar}>
        ...
        <ul className={style.girls_list}>
            { chatsElements }
        </ul>
    </div>

    <div className={style.dialog}>
        <div className='opp_mssgs'> 
            {messageElements}
        </div>
        <div className='my_mssgs'> 
            { myMessageElements }
        </div>
...
const SendMessageReduxForm = reduxForm({form: 'chatSendMessageForm'})(SendMessageForm)
