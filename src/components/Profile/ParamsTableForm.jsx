...
const ParamsTableForm = ({profile, ...props}) => {
    ...
    <div className={style.params_table_form_lfa}> 
    <Field name={"lookingForAJob"} component={Input} type={"checkbox"} />
        I'm looking for a gob
    </div>
    <div>
    <Field name={"lookingForAJobDescription"} component={Textarea} validate={required} placeholder={"Skills"} />
    </div>
    <div>
...
const ParamsTableReduxForm = reduxForm({form: 'params_table'})(ParamsTableForm)
